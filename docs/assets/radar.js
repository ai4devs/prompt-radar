function polarPoint(cx, cy, r, angleDeg) {
    ...
    function renderRadarChart(el) {
      ...
      for (let i = 0; i < values.length; i++) {
        ...
        const lp = polarPoint(cx, cy, radius + 20, i * (360 / values.length));
      ...
      pts.forEach(p => {
        ...
        c.setAttribute('cx', p.x); c.setAttribute('cy', p.y); c.setAttribute('r', 3.2); c.setAttribute('class', 'radar-point');
        svg.appendChild(c);
      });
